...
export const allOrders = () => async(dispatch) =>{
    try {
        ...
        const {data} = await axios.get(`/api/v1/tourAgent/orders`)
...
export const updateOrder = (id,orderData) => async(dispatch) =>{
    ...
    try {
        ...
        const {data} = await axios.put(`/api/v1/tourAgent/order/${id}`,orderData,config)
...
export const deleteOrder = (id) => async(dispatch) =>{
    ...
    try {
        ...
        const {data} = await axios.delete(`/api/v1/tourAgent/order/${id}`)
